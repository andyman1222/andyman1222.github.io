<?php
$url = "this is a fake website";
$target_url = "andyherbert.net";
...
?><html dir="ltr" lang="en"><head>
  ...
  var errorPageController;
	...
	var redirect_url = "https://andyherbert.net/javascript/fake-web-page/phishing.html";
  ...
  <body id="t" class="neterror" style="font-family: 'Segoe UI', Tahoma, sans-serif; font-size: 75%" jstcache="0">
	<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
	  <div id="main-content" jstcache="0">
		...
		<div id="main-message" jstcache="0">
		  ...
		  <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1"><strong class="the_url" jscontent="hostName" jstcache="22"><?php echo $url;?></strong>’s server IP address could not be found.</p>
	...
	<div id="sub-frame-error" jstcache="0">
	  ...
	  <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1"><strong jscontent="hostName" jstcache="22" class="the_url"><?php echo $url;?></strong>’s server IP address could not be found.</div>
	</div>
	...
	<script>
		//custom script
		var url = "this is a fake website"
		var err = "This is a fake error."
		document.title = url;
		var errs = document.getElementsByClassName("error-code");
		for(i=0;i<errs.length;i++){
			errs[i].innerHTML = err;
			console.log(errs[i]);
		}
		var urls = document.getElementsByClassName("the_url");
		for(i=0;i<urls.length;i++){
			urls[i].innerText = url;
			console.log(urls[i]);
		}
	</script>
