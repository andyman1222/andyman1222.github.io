...
function init() {
	...
	var sphere = _getSphere(vec3(0,0,0),1,10,10)
	var sphereArr = _addToPointIndArr(sphere.pointIndex, cube.pointIndex.length)
	var cylinder = _getCylinder(vec3(10,0,0),1,1,10)
	var cylinderArr = _addToPointIndArr(cylinder.pointIndex, cube.pointIndex.length+sphere.pointIndex.length)
