...
var materials = [new material(1, [vec4(1,0,0,1), vec4(0,0,0,1), vec4(1,1,1,1), vec4(1,1,1,1), vec4(0,0,0,1)]),
  new material(1, [vec4(0,1,0,1), vec4(1,1,1,1), vec4(0,0,0,1), vec4(1,1,1,1), vec4(1,0,0,1)]),
  new material(1, [vec4(0,0,1,1), vec4(1,1,1,1), vec4(1,1,1,1), vec4(0,0,0,1), vec4(2,0,0,1)]),
  new material(1, [vec4(1,1,0,1), vec4(0,0,0,1), vec4(0,0,0,1), vec4(1,1,1,1), vec4(1,0,0,1)]),
  new material(1, [vec4(1,0,1,1), vec4(1,1,1,1), vec4(1,1,1,1), vec4(1,1,1,1), vec4(3,0,0,1)]),
  new material(1, [vec4(0,1,1,1), vec4(0,0,0,1), vec4(0,0,0,1), vec4(1,1,1,1), vec4(1,0,0,1)])]
...
function positionValid(pos, extent){
  for(var i = 0; i < walls.length; i++){
    var o = walls[i]
    var minX = Math.min(o.transform.pos[0]+o.bounds.extent[0]+o.bounds.pos[0], o.transform.pos[0]+o.bounds.pos[0]-o.bounds.extent[0])
    var minZ = Math.min(o.transform.pos[2]+o.bounds.extent[2]+o.bounds.pos[2], o.transform.pos[2]+o.bounds.pos[2]-o.bounds.extent[2])
    var maxX = Math.max(o.transform.pos[0]+o.bounds.extent[0]+o.bounds.pos[0], o.transform.pos[0]+o.bounds.pos[0]-o.bounds.extent[0])
    var maxZ = Math.max(o.transform.pos[2]+o.bounds.extent[2]+o.bounds.pos[2], o.transform.pos[2]+o.bounds.pos[2]-o.bounds.extent[2])
