...
var materials = [new _Material(1, [vec4(1,0,0,1), vec4(0,0,0,1), vec4(1,1,1,1), vec4(1,1,1,1), vec4(1, 8, 32, 10), vec4(1,1,0,0)]),
 new _Material(1, [vec4(0,1,0,1), vec4(1,1,1,1), vec4(0,0,0,1), vec4(1,1,1,1), vec4(1, 8, 32, 10), vec4(1,1,0,0)]),
 new _Material(1, [vec4(0,0,1,1), vec4(1,1,1,1), vec4(1,1,1,1), vec4(0,0,0,1), vec4(1, 8, 32, 10), vec4(1,.1,0,0)]),
 new _Material(1, [vec4(1,1,0,1), vec4(0,0,0,1), vec4(0,0,0,1), vec4(1,1,1,1), vec4(10, 8, 32, 10), vec4(1,1,0,0)]),
 new _Material(1, [vec4(1,0,1,1), vec4(1,1,1,1), vec4(1,1,1,1), vec4(1,1,1,1), vec4(.1, 8, 32, 10), vec4(10,1,0,0)]),
 new _Material(1, [vec4(0,1,1,1), vec4(0,0,0,1), vec4(0,0,0,1), vec4(1,1,1,1), vec4(1, 8, 32, 10), vec4(1,1,0,0)])]
