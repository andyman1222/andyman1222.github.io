...
var materials = [new _Material(3, [vec4(1,0,0,1), vec4(0,0,0,1), vec4(1,1,1,1), vec4(1,1,1,1), vec4(1, 8, 32, 1), vec4(1,1,0,0)]),
  new _Material(3, [vec4(0,1,0,1), vec4(1,1,1,1), vec4(0,0,0,1), vec4(1,1,1,1), vec4(1, 8, 32, 1), vec4(1,1,0,0)]),
  new _Material(3, [vec4(0,0,1,1), vec4(1,1,1,1), vec4(1,1,1,1), vec4(0,0,0,1), vec4(1, 8, 32, 1), vec4(1,1,0,0)]),
  new _Material(3, [vec4(1,1,0,1), vec4(0,0,0,1), vec4(0,0,0,1), vec4(1,1,1,1), vec4(1, 8, 32, 1), vec4(1,1,0,0)]),
  new _Material(3, [vec4(1,0,1,1), vec4(1,1,1,1), vec4(1,1,1,1), vec4(1,1,1,1), vec4(1, 8, 32, 1), vec4(1,1,0,0)]),
  new _Material(3, [vec4(0,1,1,1), vec4(0,0,0,1), vec4(0,0,0,1), vec4(1,1,1,1), vec4(1, 8, 32, 1), vec4(1,1,0,0)])]
