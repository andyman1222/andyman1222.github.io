...
class _ScaledTexMat extends _Material {
    constructor(parallax=false, uScale = 1, vScale = 1, uDisp=0, vDisp=0, minLayers=0, maxLayers=0, heightScale=0, parameters = [vec4(1, 1, 1, 1), vec4(.5, .5, .5, 1), vec4(1, 1, 1, 1), vec4(1, 1, 1, 1), vec4(1, 10, 32, 1), vec4(1, 1, 0, 0)]){
