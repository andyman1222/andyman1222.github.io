...
class _AmbientLight extends _Primitive{
     ...
     */
    constructor(c, m, n=_AmbientLight.CLAMP, e = true){
...
class _Light extends _AmbientLight{
    constructor(c, m, n=_AmbientLight.NOCHANGE, e = true){
        super(c, m, n, e)
    }
}
...
class _DirectionalLight extends _AmbientLight{
     ...
     * @param {*} m bitwise mask indicating how many channels the light casts onto (up to 256)
     */
    constructor(t, c, m, n=_Light.CLAMP, e = true){
        super(c, m, n, e)
        this._transform = t
        this._color = c
        this._lightmask = m
...
class _PointLight extends _AmbientLight{
     ...
     */
    constructor(t, c, m, a, s = 1, n=_Light.CLAMP, na=_Light.CLAMP, e = true){
        super(c, m, n, e)
        this._transform = t
        this._attenuation = a
        this._type = 3
