...
function _engineInit(defaultCanvas, userInit, userTick, userKey = function(e) {}, userMouse = function(e) {}, defaultVertex = "../engine/default-shaders/vertex.glsl", defaultFragment = "../engine/default-shaders/fragment.glsl",
defaultPostVertex="../engine/default-shaders/postprocess-vertex.glsl", defaultPostFragment="../engine/default-shaders/postprocess-fragment.glsl", userPostTick = function(delta, time) {}) {
